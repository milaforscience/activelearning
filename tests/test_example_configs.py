...
def test_multi_fidelity_branin_tutorial_config_parses() -> None:
    ...
    config_path = REPOSITORY_ROOT / "config" / "branin_multi_fidelity.yaml"
...
def test_single_fidelity_branin_tutorial_config_parses() -> None:
    ...
    config_path = REPOSITORY_ROOT / "config" / "branin_single_fidelity.yaml"
...
def test_multi_fidelity_hartmann_tutorial_config_parses() -> None:
    ...
    config_path = REPOSITORY_ROOT / "config" / "hartmann_multi_fidelity.yaml"
...
def test_single_fidelity_hartmann_tutorial_config_parses() -> None:
    ...
    config_path = REPOSITORY_ROOT / "config" / "hartmann_single_fidelity.yaml"
