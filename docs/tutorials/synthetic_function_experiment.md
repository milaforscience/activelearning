...
All four tutorial configs use [`ConsoleLogger`](../api/logger.md#activelearning.logger.logger.ConsoleLogger) by default, so every stage gives you visible output immediately.
