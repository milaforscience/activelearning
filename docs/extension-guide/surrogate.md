...
Before implementing a new surrogate, verify that [`DummyMeanSurrogate`](../api/surrogate.md#activelearning.surrogate.dummy_mean_surrogate.DummyMeanSurrogate) (for
baselines) or [`BoTorchGPSurrogate`](../api/surrogate.md#activelearning.surrogate.botorch_surrogate.BoTorchGPSurrogate) (for GP-based work) does not already meet your
requirements.
...
- [`DummyMeanSurrogate`](../api/surrogate.md#activelearning.surrogate.dummy_mean_surrogate.DummyMeanSurrogate) — a minimal surrogate that returns a fixed mean; useful as a baseline or starting point.
- [`BoTorchGPSurrogate`](../api/surrogate.md#activelearning.surrogate.botorch_surrogate.BoTorchGPSurrogate) — a full multi-fidelity GP surrogate using BoTorch; the primary production surrogate.
...
[`BoTorchGPSurrogate`](../api/surrogate.md#activelearning.surrogate.botorch_surrogate.BoTorchGPSurrogate), not a generic [`Surrogate`](../api/surrogate.md#activelearning.surrogate.surrogate.Surrogate). Custom surrogates that wrap
